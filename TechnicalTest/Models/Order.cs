...
public partial class project1 {
    ...
    public class Order : DbTable, IQueryFactory
    {
        ...
        public Order()
        {
            ...
            Name = "Order";
            Type = "TABLE";
            UpdateTable = "dbo.[Order]"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            SalesOrder = new (this, "x_SalesOrder", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Order", "SalesOrder", "CustomMsg"),
                IsUpload = false
            };
            ...
            OrderDate = new (this, "x_OrderDate", 133, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("Order", "OrderDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Address = new (this, "x_Address", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Order", "Address", "CustomMsg"),
                IsUpload = false
            };
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("OrderDelete", parm)); // DN
        }
