...
public partial class project1 {
    ...
    {
        get => HttpData.Resolve<Item>("Item");
        set => HttpData["Item"] = value;
    }

    /// <summary>
    /// Table class for Item
    /// </summary>
    public class Item : DbTable, IQueryFactory
    {
        ...
        public Item()
        {
            ...
            Name = "Item";
            Type = "TABLE";
            UpdateTable = "dbo.Item"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Item", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);
            ...
            ItemName = new (this, "x_ItemName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Item", "ItemName", "CustomMsg"),
                IsUpload = false
            };
            ...
            Qty = new (this, "x_Qty", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Item", "Qty", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Qty", Qty);
            ...
            Price = new (this, "x_Price", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Item", "Price", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "ItemView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "ItemEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "ItemAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "ItemView",
                Config.ApiAddAction => "ItemAdd",
                Config.ApiEditAction => "ItemEdit",
                Config.ApiDeleteAction => "ItemDelete",
                Config.ApiListAction => "ItemList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "ItemList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("ItemView", parm);
            else
                url = KeyUrl("ItemView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "ItemAdd";
        ...
        {
            string url = "";
            url = KeyUrl("ItemEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("ItemList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("ItemAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("ItemList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("ItemDelete", parm)); // DN
        }
