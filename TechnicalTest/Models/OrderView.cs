...
public partial class project1 {
    ...
    {
        get => HttpData.Get<OrderView>("orderView")!;
        set => HttpData["orderView"] = value;
    }
    ...
    {
        // Constructor
        public OrderView(Controller controller) : base(controller)
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class OrderViewBase : Order
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "orderView";
        ...
        // Page name
        public string PageName => "OrderView";
        ...
        // Constructor
        public OrderViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("OrderList"); // Return to list page
                            }
                        }
                    break;
            }
